define(['plugins/http','durandal/app','knockout','plugins/router','plugins/dialog','durandal/viewEngine','jqueryprint','durandal/system'], function (http,app,ko,router,dialog,fullcalendar,viewEngine,system) {
